# Synth-Gen: Synthetic ICU Patient Data Generation System
...
2. **Update README** (30 minutes):
   - Change `synth_gen` → `packages` in all import examples
...
❌ **Import Paths**:
- README says `synth_gen`, code uses `packages`
