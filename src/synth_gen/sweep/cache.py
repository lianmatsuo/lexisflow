...
_REQUIRED_SIG_KEYS = (
    ...
    "condition_idx_hash",
    "preprocessor_hash",
    # v2: real_quality_df sourced from real_test.csv rather than training data.
    # v3: preprocessor_hash pins the signature to the preprocessor artifact, so
    # re-fitting the preprocessor invalidates stale transformed arrays.
    "schema_version",
)
