#!/usr/bin/env python3
"""03: Generate Synthetic Data - Create synthetic patient trajectories.
...
Usage:
    ...
    uv run python scripts/03_generate_synthetic.py --use-hour0
...
from packages.models import sample_trajectory
...
def main():
    ...
    if not Path(model_path).exists():
        ...
        print("Run 02_train_model.py first to train a model.")
        sys.exit(1)
    ...
    if args.use_hour0:
        ...
        if not Path(hour0_model_path).exists():
            ...
            print("Run 00c_train_hour0_model.py first to train hour-0 model.")
    ...
    print("\n" + "=" * 70)
    print("Next step: Run 04_evaluate_quality.py to assess data quality")
    print("=" * 70)
