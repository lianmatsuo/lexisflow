...
Usage:
    ...
    uv run python scripts/run_sweep.py --train-rows 10000 --synth-samples 5000
"""
...
def _build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--train-rows", type=int, default=MAX_TRAIN_ROWS)
    parser.add_argument("--synth-samples", type=int, default=N_SYNTH_SAMPLES)
    parser.add_argument("--n-jobs", type=int, default=DEFAULT_N_JOBS)
    parser.add_argument("--nt-values", type=parse_int_list, default=NT_VALUES)
    parser.add_argument("--noise-values", type=parse_int_list, default=NOISE_VALUES)
    parser.add_argument(
        "--model-type",
    ...
    parser.add_argument("--privacy-max-rows", type=int, default=2000)
...
def main() -> None:
    ...
    models_dir = Path("artifacts/sweep")
