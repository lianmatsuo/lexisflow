#!/usr/bin/env python3
"""00: Prepare Hour-0 Data - Extract initial patient states for IID generation.
...
3. Apply shared feature pruning policy from packages.data
...
def main():
    ...
    # Align with 01_preprocess_data.py: drop cached 100%-missing columns.
    ...
    # Align with 01_preprocess_data.py: drop shared datetime columns upfront.
    ...
    print("\n" + "=" * 70)
    print("Next steps:")
    print("  1. Run 00b_fit_hour0_preprocessor.py to fit preprocessor")
    print("  2. Run 00c_train_hour0_model.py to train Hour-0 model")
    print("=" * 70)
