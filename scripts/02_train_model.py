#!/usr/bin/env python3
"""02: Model Training - Train Forest-Flow on preprocessed data.

This script trains a Forest-Flow generative model on autoregressive MIMIC-III data.
...
from packages.data import TabularPreprocessor, split_static_dynamic
...
def main():
    ...
    if not Path(input_path).exists():
        ...
        print("Run 01_preprocess_data.py first to prepare data.")
        sys.exit(1)
    ...
    if use_prefitted:
        ...
        print("   → Run scripts/01b_fit_preprocessor.py first to fit on full data")
        print()
    ...
    print("\n" + "=" * 70)
    print("Next step: Run 03_generate_synthetic.py to generate data")
    print("=" * 70)
